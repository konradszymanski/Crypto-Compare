...
const takeParameters = data => {
    ...
    data.forEach(p => {
        coins.push(
            ...
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.current_price),
            ...
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.high_24h),
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.low_24h),
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.price_change_24h),
            ...
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.ath),
            p.ath_change_percentage,
            new Date(p.ath_date).toLocaleDateString(),
            new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 9 }).format(p.atl),
